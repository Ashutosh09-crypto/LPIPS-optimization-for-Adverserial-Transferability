...
def get_parser():
    ...
    parser.add_argument('--num_copies', default=1, type=int, help='number of copies') # should be 20
...
def main():
    ...
    if not args.eval:
        ...
        for batch_idx, [filenames, images] in tqdm.tqdm(enumerate(load_images(os.path.join(args.input_dir,'val_rs'), args.batchsize))):
